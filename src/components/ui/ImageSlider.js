          ...
          >
            {index === current && (
              <img
                ...
                key={index}
                // className=" rounded-md border-opacity-75 w-11/12 mx-auto h-4/6 lg:max-h-64 xl:max-h-80 xl:max-h-96 lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl 2xl:max-h-96  hover:opacity-90"
                className=" rounded-md border-opacity-75 w-11/12 mx-auto h-auto hover:opacity-90 xl:max-w-2xl"
              />
            )}
          </div>
        ))}
