    ...
    <Fragment>
      {unitProfile && (
        <div className="2xl:container mx-auto px-1 md:px-5">
          <div className="flex flex-col md:flex-row md:justify-between items-center my-2">
            <h1 className="text-xl md:text-4xl lg:text-4xl font-mono underline uppercase">
